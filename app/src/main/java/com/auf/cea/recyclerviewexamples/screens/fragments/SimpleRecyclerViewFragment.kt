 ...
 * Use the [SimpleRecyclerViewFragment.newInstance] factory method to
...
class SimpleRecyclerViewFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SimpleRecyclerViewFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SimpleRecyclerViewFragment().apply {
